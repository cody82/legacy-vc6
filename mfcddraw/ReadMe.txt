========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : mfcddraw
========================================================================


Diese mfcddraw-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre mfcddraw-Anwendung bilden.
...
res\mfcddraw.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei mfcddraw.rc eingebunden.
...
mfcddrawDlg.h, mfcddrawDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CMfcddrawDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in mfcddraw.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	mfcddraw.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
